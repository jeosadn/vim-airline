...
function! airline#themes#zenburn#refresh()
  ...
  let s:N3 = airline#themes#get_highlight2(['Float', 'fg'], ['NonText', 'fg'])

  let g:airline#themes#zenburn#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
  let s:Nmod = airline#themes#get_highlight2(['Comment', 'fg'], ['NonText', 'fg'])
  ...
  let s:IA = airline#themes#get_highlight2(['Float', 'fg'], ['VertSplit', 'fg'])
